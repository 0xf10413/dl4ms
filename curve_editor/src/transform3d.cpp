/*
 * transform3d.cpp
 * Copyright (C) 2017 oasis <oasis@oasis-simu>
 *
...
const QVector3D Transform3D::LocalForward(.0f, .0f, 1.f);
const QVector3D Transform3D::LocalUp(.0f, 1.0f, 0.f);
const QVector3D Transform3D::LocalRight(1.0f, .0f, 0.f);
